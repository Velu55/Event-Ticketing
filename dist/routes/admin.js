...
router.put("/create-event", schema_1.eventSchema, is_auth_1.default, is_admin_1.default, vaildation_1.default, admin_1.default.newEvent);
router.post("/update-event", schema_1.eventSchema, is_auth_1.default, is_admin_1.default, vaildation_1.default, admin_1.default.updateEvent);
